...
@section("homeContent")
    <div id="slider">
        <div class="row">
            <div class="col-12">
                <div class="slides">
                    <div class="slide-item fade1">
                        <img src="{{ ('FE/img/banners/banner1.jpg') }}" alt="img">
                    </div>
                    <div class="slide-item fade1">
                        <img src="{{ ('FE/img/banners/banner2.jpg') }}" alt="img">
                    </div>
                    <div class="slide-item fade1">
                        <img src="{{ ('FE/img/banners/banner3.jpg') }}" alt="img">
                    </div>

                    <a class="slide-btn-pre" onclick="plusSlides(-1)">&#10094;</a>
                    <a class="slide-btn-next" onclick="plusSlides(1)">&#10095;</a>
                </div>

                <br>

                <div class="slide-btn-dots">
                    <span class="slide-btn-dot active" onclick="currentSlides(1)"></span>
                    <span class="slide-btn-dot" onclick="currentSlides(2)"></span>
                    <span class="slide-btn-dot" onclick="currentSlides(3)"></span>
                </div>
            </div>
        </div>
    </div>

    <div class="banner-ship mb-3">
        <div class="row">
            <div class="col-12">
                <img src="{{ ('FE/img/banners/banner4.jpg') }}" alt="Ship" style="min-height: 150px;">
            </div>
        </div>
    </div>

    <div class="product-carousel" id="outstandingProduct">
        <h5 class="product-carousel-header">SẢN PHẨM NỔI BẬT</h5>

        <div class="owl-carousel owl-theme">
            @foreach($outstandingProducts as $item)
            <div class="item product-carousel-item" title="{{ $item->pro_name }}">
                <a href="{{ URL::to('/details?id='.$item->pro_id) }}" style="text-decoration: none; color: #333;">
                    <div class="product-carousel-head">
                        <img src="{{ asset('FE/img/products/'.$item->pro_image) }}" class="product-carousel-img">
                    </div>
            ...
            <div class="col-md-3 col-12 mb-3">
                <div class="menu-category">
                    ...
                    <ul class="menu-category__list">
                        ...
                        <li class="menu-category__item <?php echo $active == $item->c_id ? "active" : "" ?>"><a href="?category={{ $item->c_id }}">{{ $item->c_name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function renderPaginationControls(currentPage) {
                ...
                prevItem.innerHTML = `<a class="page-link" href="#outstandingProduct"><i class="fa-solid fa-chevron-left"></i></a>`;
                ...
                nextItem.innerHTML = `<a class="page-link" href="#outstandingProduct"><i class="fa-solid fa-chevron-right"></i></a>`;
            ...
            function appendPageNumber(paginationList, pageNumber, currentPage) {
                ...
                pageItem.innerHTML = `<a class="page-link" href="#outstandingProduct">${pageNumber}</a>`;
